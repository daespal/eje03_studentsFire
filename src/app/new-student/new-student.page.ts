...
export class NewStudentPage implements OnInit {
  ...
  constructor(private studentService: StudentService, private fb: FormBuilder, private navCtrl: NavController, private router: Router, private alertController: AlertController) { }
  ...
  public async saveStudent() {
    const alert = await this.alertController.create({
      header: 'Confirmación',
      subHeader: '¿Estás seguro que deseas guardar el estudiante?',
...
//tarea cerrar la pantalla cuando se guarde. 
